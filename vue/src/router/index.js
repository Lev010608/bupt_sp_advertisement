...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'information', name: 'Information', meta: { name: '南太论坛' }, component: () => import('../views/front/Information') },
      { path: 'informationDetail', name: 'InformationDetail', meta: { name: '发布详情' }, component: () => import('../views/front/InformationDetail') },
