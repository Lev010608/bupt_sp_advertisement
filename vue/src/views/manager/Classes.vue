<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入班级查询" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="description" label="班级描述" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="description" label="班级描述">
        ...
        <el-form-item prop="teacherId" label="班主任">
          <el-select v-model="form.teacherId" placeholder="请选择专业" style="width: 100%">
